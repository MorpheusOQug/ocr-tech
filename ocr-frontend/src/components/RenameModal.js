...
function RenameModal({ isOpen, onClose, onConfirm, document, isRenaming, error }) {
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <div className="mt-4">
                    ...
                    <input
                      ...
                      name="documentName"
                      id="documentName"
                      className="mt-1.5 w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm dark:bg-gray-700 dark:text-white focus:border-blue-500 focus:ring-blue-500"
                      value={newName}
